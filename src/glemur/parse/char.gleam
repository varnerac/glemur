...
// Also handles normalization of CRLF or CR to newline
pub fn parse_char(
  bs: BitString,
...
pub fn is_base_char(c: Int) -> Bool {
  { c >= 0x0041 && c <= 0x005A } || { c >= 0x0061 && c <= 0x007A } || {
    ...
    c >= 0x014A && c <= 0x017E
  } || { c >= 0x0180 && c <= 0x01C3 } || { c >= 0x01CD && c <= 0x01F0 } || {
    c >= 0x01F4 && c <= 0x01F5
  } || { c >= 0x01FA && c <= 0x0217 } || { c >= 0x0250 && c <= 0x02A8 } || {
    c >= 0x02BB && c <= 0x02C1
  } || { c == 0x0386 } || { c >= 0x0388 && c <= 0x038A } || { c == 0x038C } || {
    c >= 0x038E && c <= 0x03A1
  } || { c >= 0x03A3 && c <= 0x03CE } || { c >= 0x03D0 && c <= 0x03D6 } || {
    c == 0x03DA
    ...
    c >= 0x0905 && c <= 0x0939
  } || { c == 0x093D } || { c >= 0x0958 && c <= 0x0961 } || {
    c >= 0x0985 && c <= 0x098C
  } || { c >= 0x098F && c <= 0x0990 } || { c >= 0x0993 && c <= 0x09A8 } || {
    c >= 0x09AA && c <= 0x09B0
  } || { c == 0x09B2 } || { c >= 0x09B6 && c <= 0x09B9 } || {
    c >= 0x09DC && c <= 0x09DD
    ...
    c >= 0x0B85 && c <= 0x0B8A
  } || { c >= 0x0B8E && c <= 0x0B90 } || { c >= 0x0B92 && c <= 0x0B95 } || {
    c >= 0x0B99 && c <= 0x0B9A
    ...
    c >= 0x0D0E && c <= 0x0D10
  } || { c >= 0x0D12 && c <= 0x0D28 } || { c >= 0x0D2A && c <= 0x0D39 } || {
    c >= 0x0D60 && c <= 0x0D61
    ...
    c >= 0x1102 && c <= 0x1103
  } || { c >= 0x1105 && c <= 0x1107 } || { c == 0x1109 } || {
    c >= 0x110B && c <= 0x110C
  } || { c >= 0x110E && c <= 0x1112 } || { c == 0x113C } || { c == 0x113E } || {
    c == 0x1140
  } || { c == 0x114C } || { c == 0x114E } || { c == 0x1150 } || {
    c >= 0x1154 && c <= 0x1155
  } || { c == 0x1159 } || { c >= 0x115F && c <= 0x1161 } || { c == 0x1163 } || {
    c == 0x1165
  } || { c == 0x1167 } || { c == 0x1169 } || { c >= 0x116D && c <= 0x116E } || {
    c >= 0x1172 && c <= 0x1173
  } || { c == 0x1175 } || { c == 0x119E } || { c == 0x11A8 } || { c == 0x11AB } || {
    c >= 0x11AE && c <= 0x11AF
  } || { c >= 0x11B7 && c <= 0x11B8 } || { c == 0x11BA } || {
    c >= 0x11BC && c <= 0x11C2
    ...
    c == 0x1FBE
  } || { c >= 0x1FC2 && c <= 0x1FC4 } || { c >= 0x1FC6 && c <= 0x1FCC } || {
    c >= 0x1FD0 && c <= 0x1FD3
  } || { c >= 0x1FD6 && c <= 0x1FDB } || { c >= 0x1FE0 && c <= 0x1FEC } || {
    c >= 0x1FF2 && c <= 0x1FF4
  } || { c >= 0x1FF6 && c <= 0x1FFC } || { c == 0x2126 } || {
    c >= 0x212A && c <= 0x212B
...
pub fn is_combining_char(c: Int) -> Bool {
  { c >= 0x0300 && c <= 0x0345 } || { c >= 0x0360 && c <= 0x0361 } || {
    c >= 0x0483 && c <= 0x0486
  } || { c >= 0x0591 && c <= 0x05A1 } || { c >= 0x05A3 && c <= 0x05B9 } || {
    c >= 0x05BB && c <= 0x05BD
    ...
    c >= 0x093E && c <= 0x094C
  } || c == 0x094D || { c >= 0x0951 && c <= 0x0954 } || {
    c >= 0x0962 && c <= 0x0963
  } || { c >= 0x0981 && c <= 0x0983 } || c == 0x09BC || c == 0x09BE || c == 0x09BF || {
    c >= 0x09C0 && c <= 0x09C4
    ...
    c >= 0x0A70 && c <= 0x0A71
  } || { c >= 0x0A81 && c <= 0x0A83 } || { c == 0x0ABC } || {
    c >= 0x0ABE && c <= 0x0AC5
  } || { c >= 0x0AC7 && c <= 0x0AC9 } || { c >= 0x0ACB && c <= 0x0ACD } || {
    c >= 0x0B01 && c <= 0x0B03
  } || { c == 0x0B3C } || { c >= 0x0B3E && c <= 0x0B43 } || {
    c >= 0x0B47 && c <= 0x0B48
    ...
    c >= 0x0C3E && c <= 0x0C44
  } || { c >= 0x0C46 && c <= 0x0C48 } || { c >= 0x0C4A && c <= 0x0C4D } || {
    c >= 0x0C55 && c <= 0x0C56
  } || { c >= 0x0C82 && c <= 0x0C83 } || { c >= 0x0CBE && c <= 0x0CC4 } || {
    c >= 0x0CC6 && c <= 0x0CC8
  } || { c >= 0x0CCA && c <= 0x0CCD } || { c >= 0x0CD5 && c <= 0x0CD6 } || {
    c >= 0x0D02 && c <= 0x0D03
  } || { c >= 0x0D3E && c <= 0x0D43 } || { c >= 0x0D46 && c <= 0x0D48 } || {
    c >= 0x0D4A && c <= 0x0D4D
  } || c == 0x0D57 || { c == 0x0E31 } || { c >= 0x0E34 && c <= 0x0E3A } || {
    c >= 0x0E47 && c <= 0x0E4E
  } || c == 0x0EB1 || { c >= 0x0EB4 && c <= 0x0EB9 } || {
    c >= 0x0EBB && c <= 0x0EBC
  } || { c >= 0x0EC8 && c <= 0x0ECD } || { c >= 0x0F18 && c <= 0x0F19 } || c == 0x0F35 || c == 0x0F37 || c == 0x0F39 || c == 0x0F3E || {
    c == 0x0F3F
  } || { c >= 0x0F71 && c <= 0x0F84 } || { c >= 0x0F86 && c <= 0x0F8B } || {
    c >= 0x0F90 && c <= 0x0F95
  } || { c == 0x0F97 } || { c >= 0x0F99 && c <= 0x0FAD } || {
    c >= 0x0FB1 && c <= 0x0FB7
  } || c == 0x0FB9 || { c >= 0x20D0 && c <= 0x20DC } || c == 0x20E1 || {
    c >= 0x302A && c <= 0x302F
  } || c == 0x3099 || c == 0x309A
}
...
pub fn is_digit(c: Int) -> Bool {
  { c >= 0x0030 && c <= 0x0039 } || { c >= 0x0660 && c <= 0x0669 } || {
    ...
    c >= 0x0BE7 && c <= 0x0BEF
  } || { c >= 0x0C66 && c <= 0x0C6F } || { c >= 0x0CE6 && c <= 0x0CEF } || {
    c >= 0x0D66 && c <= 0x0D6F
